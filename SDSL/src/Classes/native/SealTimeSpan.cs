...
public static class SealTimeSpan
{
    ...
    public static SealValue TotalDays(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().TotalDays;
    
    [FunctionExport("total_hours() -> Number")]
    public static SealValue TotalHours(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().TotalHours;
    
    [FunctionExport("total_minutes() -> Number")]
    public static SealValue TotalMinutes(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().TotalMinutes;

    [FunctionExport("total_seconds() -> Number")]
    public static SealValue TotalSeconds(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().TotalSeconds;
    
    [FunctionExport("total_milliseconds() -> Number")]
    public static SealValue TotalMilliseconds(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().TotalMilliseconds;
    
    [FunctionExport("total_microseconds() -> Number")]
    public static SealValue TotalMicroseconds(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().TotalMicroseconds;
    
    [FunctionExport("total_nanoseconds() -> Number")]
    public static SealValue TotalNanoseconds(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().TotalNanoseconds;
    
    [FunctionExport("days() -> Number")]
    public static SealValue Days(SealValue self, ReadOnlySpan<SealValue> args)
    ...
    public static SealValue Minutes(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().Minutes;
    
    [FunctionExport("seconds() -> Number")]
    public static SealValue Seconds(SealValue self, ReadOnlySpan<SealValue> args)
        => self.AsTimeSpan().Seconds;
    
    [FunctionExport("milliseconds() -> Number")]
    public static SealValue Milliseconds(SealValue self, ReadOnlySpan<SealValue> args)
